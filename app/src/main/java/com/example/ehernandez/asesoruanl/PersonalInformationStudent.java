...
public class PersonalInformationStudent extends AppCompatActivity{
                ...
                public void done(ParseException e) {
                    if (e == null) {
                        ...
                        if (message.equals("the email address " + email + " has already been taken")) {
                            ...
                            tv_message.setText("Ya existe un alumno con este correo electronico.");
                        } else {
                            tv_message.setVisibility(View.VISIBLE);
    ...
    public void CallAddAsesoryActivity(){
        Intent intent = new Intent(PersonalInformationStudent.this, MyConsultancies.class);
